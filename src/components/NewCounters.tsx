...
export default function NewCounters({ counterIdProps, increaseCounter, removeCounter }: CounterProps) {
    return(
        <div className="relative flex w-50 flex-col items-center border border-blue-500 rounded-xl bg-black p-8 shadow-md">
            ...
            <button onClick={() => increaseCounter(counterIdProps.id)} disabled={counterIdProps.value >= 3}
